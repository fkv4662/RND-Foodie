...
const CCPLogs = () => {
  ...
  const fetchLogs = async () => {
    try {
      const response = await fetch("http://localhost:5000/api/ccp/logs");
      ...
      <div style={{ padding: "20px" }}>
        ...
        {activeTab === "manual" && !loading && (
          <div style={{ backgroundColor: "white", padding: "20px", borderRadius: "4px" }}>
            ...
            <button onClick={() => window.history.back()} style={{ marginTop: "20px", padding: "10px 20px", backgroundColor: "black", color: "white", border: "none", cursor: "pointer", borderRadius: "4px" }}>
              ← BACK
            </button>
          </div>
        )}
